"""
chimera-runtime -- License Manager

Validates signed JWT license keys for tier-gated features.
Keys are issued by the Chimera dashboard (runtime.chimera-protocol.com).

License resolution order:
  1. Programmatic: chimera_runtime.activate_license("chm_lic_...")
...
class TierUpgradeRequired(LicenseError):
    ...
    def __init__(self, feature: str, required_tier: str, current_tier: str):
        ...
        super().__init__(
            ...
            f"Upgrade at https://runtime.chimera-protocol.com/settings"
        )
...
def activate_license(key: str) -> ChimeraLicense:
    ...
    Usage::
        ...
        import chimera_runtime
        chimera_runtime.activate_license("chm_lic_eyJ...")
    """
    global _active_license
    with _license_lock:
...
def _validate_key(raw_key: str) -> ChimeraLicense:
    ...
    try:
        ...
        raise LicenseError(
            ...
            "Install with: pip install 'chimera-runtime[pro]'"
        )
    ...
    try:
        payload: Dict[str, Any] = jwt.decode(
            ...
            issuer="chimera-runtime",
        )
    except jwt.ExpiredSignatureError:
        raise LicenseError(
            "License key has expired. "
            "Renew at https://runtime.chimera-protocol.com/settings"
        )
