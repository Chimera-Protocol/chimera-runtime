"""chimera-runtime explain — Art. 86 Right to Explanation."""
...
def explain_cmd(ctx, decision_id, output, audit_dir, open_browser):
    ...
    \b
    Examples:
        chimera-runtime explain --id dec_abc123
        chimera-runtime explain --id dec_abc123 --output ./reports/explanation.html --open
    """
