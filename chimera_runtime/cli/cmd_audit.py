"""chimera-runtime audit — Query and manage audit records."""
...
def audit_cmd(ctx, last, result, after, before, decision_id, stats,
    ...
    Examples:
        ...
        chimera-runtime audit --result BLOCKED --after 2026-01-01T00:00:00Z
        chimera-runtime audit --stats
        chimera-runtime audit --id dec_abc123
