"""
chimera-runtime — Annex IV Documentation Generator
...
# Sections that are auto-filled from chimera-runtime data
...
class AnnexIVGenerator:
    ...
    def _build_context(self) -> Dict[str, Any]:
        ...
        if is_csl and CSL_CORE_AVAILABLE:
            ...
            ctx["verification_method"] = "Not available — install chimera-runtime[csl]"
        else:
