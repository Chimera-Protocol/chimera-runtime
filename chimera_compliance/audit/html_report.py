"""
chimera-compliance — HTML Audit Report Generator
...
<div class="container">
    <div class="header">
        <h1>🛡️ chimera-compliance Audit Report</h1>
        <div class="meta">
    ...
    <footer>
        Generated by chimera-compliance v{_esc(a.version)} &nbsp;|&nbsp; Schema {_esc(record.schema_version)} &nbsp;|&nbsp; Powered by CSL-Core + Z3
    </footer>
</div>
</body>
</html>'''
