"""
chimera-compliance — AutoGen Integration

Provides:
  - ChimeraComplianceAgent: Wraps AutoGen agents with compliance guard
  - guard_function_call(): Decorator for function call compliance checking

Install: pip install chimera-compliance[autogen]
...
def guard_function_call(
    ...
    """
    Decorator that wraps a function with compliance checking.
...
class ChimeraComplianceAgent:
    """
    Wraps an AutoGen agent with compliance checking on function calls.
    ...
    def _create_guarded_fn(self, name: str, fn: Callable) -> Callable:
        ...
        def guarded(*args: Any, **kwargs: Any) -> Any:
            ...
            if evaluation.result == "BLOCKED":
                ...
                return f"[BLOCKED by chimera-compliance] {violations}"
