"""
chimera-compliance — Policy Manager
...
Install CSL-Core for Z3 support: pip install chimera-compliance[csl]
"""
...
class PolicyManager:
    """
    Manages the lifecycle of a policy for chimera-compliance.
    ...
    def _load_csl(self) -> None:
        if not CSL_CORE_AVAILABLE:
            raise PolicyError(
                ...
                f"Install it with: pip install chimera-compliance[csl]"
            )
