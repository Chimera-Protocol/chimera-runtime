"""
chimera-compliance CLI — License Management

Usage:
    chimera-compliance license status       # Show current license tier
    chimera-compliance license activate     # Activate a license key
    chimera-compliance license deactivate   # Remove stored license key
"""
...
def license_status():
    ...
    if lic.tier_name == "free":
        console.print()
        console.print(
            "[dim]Upgrade at [bold]https://compliance.chimera-protocol.com/settings[/bold] "
