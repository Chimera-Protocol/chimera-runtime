"""
chimera-compliance CLI — Rich Display Components
...
BANNER = r"""[cyan]
    ...
    ╚██████╗██║  ██║██║██║ ╚═╝ ██║███████╗██║  ██║██║  ██║
     ╚═════╝╚═╝  ╚═╝╚═╝╚═╝   ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝[/cyan]
[dim]  EU AI Act Compliant Agent Framework[/dim]
"""

BANNER_MINI = "[bold cyan]🛡️  chimera-compliance[/bold cyan] [dim]— EU AI Act Compliant Agent Framework[/dim]"
